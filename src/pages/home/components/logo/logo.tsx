...
export function Logo(): JSX.Element {
    const bgRef = useRef() as RefObject<HTMLDivElement>;
    const outlineLogoRef = useRef() as RefObject<SVGPathElement>;
    const solidLogoRef = useRef() as RefObject<HTMLImageElement>;
